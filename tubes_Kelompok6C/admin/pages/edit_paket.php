...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <h1 class="h3 mb-0 text-gray-800">Update Data Paket</h1>
                            </div>
                            <!-- /.panel-heading -->
    ...
    <form method="POST" class="my-login-validation" novalidate="">
            <div class="form-group mb-3">
                ...
                <input value="<?php echo $data ['judul'];?>" id="judul" type="text" class="form-control" name="judul" required autofocus>

            </div>

            <div class="form-group mb-3">
                <label for="destinasi">Destinasi</label>
                <input value="<?php echo $data ['destinasi'];?>" id="destinasi" type="text" class="form-control" name="destinasi" required>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input value="<?php echo $data ['deskripsi'];?>" id="deskripsi" type="textarea" class="form-control" name="deskripsi" required>
            </div>
        ...
        <?php
            if (isset($_POST['btnUpdate'])){
                ...
                $query = "UPDATE packages SET judul='$judul',destinasi='$destinasi',harga='$harga',deskripsi='$deskripsi' WHERE id='$id'";
                $hasil = mysqli_query($koneksi,$query);
